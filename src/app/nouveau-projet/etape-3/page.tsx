  ...
  return (
    <AppShell role="Chef de projet" notifications={3}>
      <div className="flex h-full flex-col gap-3">
        <PageTitle
          title="Créer un nouveau projet — Étape 3/3"
        ...
        <RouteMap
          hints={[
            ...
            { action: "Étape précédente", target: "ouvre “Créer un nouveau projet — Étape 2/3”", icon: <ArrowLeft className="h-4 w-4 text-[#B45F09]" /> },
